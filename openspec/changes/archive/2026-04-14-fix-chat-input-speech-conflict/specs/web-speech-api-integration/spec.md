...
Defines the component-level Web Speech API integration for chat input, ensuring each component maintains its own speech recognition instance without global state conflicts.
